...
const env = {
  ...
  API_BODY_LIMIT: process.env.API_BODY_LIMIT || '15mb',
  ...
  DB_AUTO_MIGRATE: parseBoolean(process.env.DB_AUTO_MIGRATE, true),
  DB_MIGRATE_ALTER: parseBoolean(process.env.DB_MIGRATE_ALTER, false),
  DB_MIGRATE_FORCE: parseBoolean(process.env.DB_MIGRATE_FORCE, false),
